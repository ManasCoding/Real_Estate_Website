    ...
    <div className="w-full overflow-x-hidden">
			<header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-white/70 border-b border-purple-100 shadow-sm transition-all duration-300">
				<nav className="container px-6 py-4 flex justify-between items-center">
					...
					<div
            className={`${
            isNavOpen ? 'flex flex-col' : 'hidden'} md:flex md:space-x-8 absolute md:static top-full left-0 w-full md:w-auto bg-white/95 md:bg-transparent backdrop-blur-md md:backdrop-blur-none p-6 md:p-0 shadow-lg md:shadow-none z-10 border-b md:border-none border-gray-100`
            }>
