...
import {
  ...
  HamburgerIcon,
  FilterIcon } from
'@/icons/landing-page-icons'; // Assuming you have a filter icon
  ...
  return (
    <div>
			<nav className="px-4 md:px-32 py-4 flex justify-between items-center">
				...
				<div
          className={`${
          isNavOpen ? 'flex flex-col' : 'hidden'} md:flex md:space-x-6 absolute md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent p-4 md:p-0 shadow-md md:shadow-none z-10`
          }>
