				...
				<div className="absolute inset-0 flex items-center justify-center z-20 p-20 bg-gradient-to-t from-gray-900/60 to-transparent">
					<div className="self-end text-white max-w-2xl">
						<h2 className="text-4xl font-bold tracking-tight mb-4">
							Unlock premium real estate insights.
						</h2>
						<p className="text-lg text-white/80 font-medium">
							Create your free account today to save curated properties, track deep value estimates, and negotiate directly with elite global agents instantly.
						</p>
					</div>
				</div>
			</div>
