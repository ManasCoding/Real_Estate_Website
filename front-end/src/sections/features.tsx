...
const AnimatedCard = ({ index, imageSrc, heading, details, buttonText }: AnimatedCardProps) => {
	...
	return (
		...
		>
			...
			<div className="p-6">
				...
				<Button 
					variant="outline" 
					className="w-full mt-auto font-semibold border-primary/30 text-primary hover:bg-primary hover:text-white transition-all shadow-sm"
				>
					{buttonText}
				</Button>
			</div>
